...
PNGS=$(echo "arrow hand dynamite bomb vowel consonant copy timer wood stone magnifying-glass bug gear" | perl -ane "for (@F) {print qq(${WORKDIR}\/\$_.png )}")
echo $PNGS
montage $PNGS -background '#ffffff00' -tile 16x1 public/assets/sprites-large.png
